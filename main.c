...
int main(void) {
    setlocale(LC_ALL,"pt_BR.UTF-8"); //Necessário para 
    bool ok;
    ...
    do {
        ...
        switch (op) {
            case 1:
                    ...
                    char nome[100];
                    //id default para entrada no while
                    id = -2;
                    int priori = 0;
                    //Permanece recenbendo entrada de id até encontrar um válido ou -1(novo paciente)
                    ...
                    if(paciente != NULL){//Se o paciente existir
                        //Verifica se o paciente existente já não está na fila
                    ...
                    while(priori < 1 || priori > 5){
                        //Não permite digitar valor de prioridade inválido
                    ...
                    //Verifica se o paciente foi corretamente inserido na fila de espera
                    ...
                    //Apresenta ao usuário os dados do novo paciente
